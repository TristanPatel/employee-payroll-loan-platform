...
The portal sits at **https://staffloans.richmond-afri.com**. It is the only place from which a Richmond Finance loan may be applied for, reviewed, approved, contracted, disbursed, or settled. It replaces all prior spreadsheets, paper application files, and ad-hoc email approvals for this product.
...
1. Go to **https://staffloans.richmond-afri.com/sign-in**.
...
|---|---|
| Sign in | https://staffloans.richmond-afri.com/sign-in |
| Recover password | https://staffloans.richmond-afri.com/auth/recover |
| Your dashboard | the portal sends you there automatically after sign-in |
| Public contract verifier | https://staffloans.richmond-afri.com/verify/[contract-id] |
| Apply (Sino Metals example) | https://staffloans.richmond-afri.com/apply/sino-metals-leach-zambia-limited |
