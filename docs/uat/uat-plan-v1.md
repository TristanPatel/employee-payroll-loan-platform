...
The portal under test is at **https://staffloans.richmond-afri.com** (production / `main`). All test loans are real database rows; they do not need to be reversed because the test employer pools are sized for it.
...
1. Open `https://staffloans.richmond-afri.com/apply/sino-metals-leach-zambia-limited`.
...
```
Portal:   https://staffloans.richmond-afri.com
